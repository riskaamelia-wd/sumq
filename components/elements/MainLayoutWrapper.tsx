...
export default function MainLayout({
  ...
  return (
    <div className="min-h-screen bg-[#0D0F14] relative">
      {/* * Enhanced Background Decorations (template-inspired) - Fixed behind everything */}
      ...
      {/* Main Content with Template-Inspired Design - Scrollable */}
      <motion.main
        key={activeView}
        initial={{ opacity: 0, scale: 0.98 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.4, ease: "easeOut" }}
        className="fixed left-64 top-0 right-0 bottom-0 overflow-y-auto z-10"
      >
        ...
        >
          ...
          {/* * Content wrapper with glass effect - Scrollable */}
