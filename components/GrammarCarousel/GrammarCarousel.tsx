...
//           {/* INFO CARD STYLE */}
//           <div
//             className={`relative h-full bg-gradient-to-br ${slide.bg_color} p-8`}
//           >
...
//                 <div className={`${slide.decor_color} text-2xl`}>✺</div>
//                 <div className="flex gap-2">
//                   <div className={`${slide.decor_color} text-xl`}>⟶</div>
//                   <div className={slide.decor_color}>★</div>
//                 </div>
//               </div>
...
//                   {slide.what_you_learn.map((item, i) => (
//                     <li
//                       key={i}
//                       className="text-gray-800 text-xs flex items-start gap-2"
//                     >
//                       <span
//                         className={`${slide.decor_color} mt-0.5 text-xs flex-shrink-0`}
//                       >
//                         ✦
//                       </span>
...
//               {/* Decorative corner */}
//               <div
//                 className={`absolute bottom-6 right-6 ${slide.decor_color} text-xl opacity-30`}
//               >
//                 ⟲
//               </div>
